(function() {
  ...
  const tarifs = Vue.createApp({
    ...
    template: `
    <div id="tarifsArchive" class="tarifs" :class=" { noscroll: noscroll } ">
      <div class="d-flex justify-between flex-column flex-md-row align-center mb-17">
        <div class="switch mb-10 mb-md-0">
          <div class="item internet active">
            <div class="icon">
