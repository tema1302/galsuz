...
<main id="primary" class="page specials">
		<div class="container">
				<div class="head d-flex flex-column align-center">
					<h1 class="text-style-display-lg-semibold color-gray-900 text-center mb-20"><?php echo esc_html__('Блог', 'galsuz'); ?></h1>
				</div>
				<div class="row">
					<?php
						$counter = 0;
					...
					?>
						<div class="col-12 <?php echo $counter < 3 ? 'col-md-6 mb-15 mb-md-25 pb-md-7' : 'col-md-4 mb-15 mb-md-24'; ?>">
							<div class="special">
								<?php if($image) { ?><div class="img mb-16" style="background-image: url('<?php echo $image[0]; ?>');"></div><?php } ?>
