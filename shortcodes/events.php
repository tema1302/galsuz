...
add_shortcode("events", function ($atts, $content = '') {
  ...
  <div class="d-flex align-center justify-between mb-12 pt-24" v-if="options.events">
    <h1>'. esc_html__('События и новости компании', 'galsuz') .'</h1>
    <a class="d-flex align-center nowrap" href="' . get_post_type_archive_link('events') . '">
  ...
  <div class="events row" v-if="options.events">';
